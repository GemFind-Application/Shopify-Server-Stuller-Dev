...
class Webhook extends CI_Controller {
	...
	public function setShopifyUninstall(){
		...
		$admin_subject = $data['name']. ": GemFind Stuller Dev App Uninstalled";
		$admin_toEmail = ['dev@gemfind.com',];
		$this->email->from('noreply@gemfind.com', 'GemFind Stuller Dev');
		...
		$admin_subject = $data['name']. " : How did GemFind Stuller Dev not meet your needs?";
		$admin_toEmail = $customerData->email ? $customerData->email : $data['customer_email'];
		$this->email->from('noreply@gemfind.com', 'GemFind Stuller Dev');
		$this->email->to($admin_toEmail);
		$this->email->reply_to('noreply@gemfind.com', 'GemFind Stuller Dev');
		$this->email->subject($admin_subject);
